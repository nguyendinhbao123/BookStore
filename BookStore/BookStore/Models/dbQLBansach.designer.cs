...
namespace BookStore.Models
{
	...
	public partial class Admin : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _UserAmin;
		
		private string _PassAmin;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnUserAminChanging(string value);
    partial void OnUserAminChanged();
    partial void OnPassAminChanging(string value);
    partial void OnPassAminChanged();
    ...
    partial void OnHotenChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UserAmin", DbType="VarChar(30) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string UserAmin
		{
			get
			{
				return this._UserAmin;
			}
			set
			{
				if ((this._UserAmin != value))
				{
					this.OnUserAminChanging(value);
					this.SendPropertyChanging();
					this._UserAmin = value;
					this.SendPropertyChanged("UserAmin");
					this.OnUserAminChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PassAmin", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string PassAmin
		{
			get
			{
				return this._PassAmin;
			}
			set
			{
				if ((this._PassAmin != value))
				{
					this.OnPassAminChanging(value);
					this.SendPropertyChanging();
					this._PassAmin = value;
					this.SendPropertyChanged("PassAmin");
					this.OnPassAminChanged();
				}
			}
		}
